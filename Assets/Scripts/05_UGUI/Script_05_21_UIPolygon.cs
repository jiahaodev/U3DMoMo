...
public class Script_05_21_UIPolygon : Image 
{
    ...
    //设置只响应点击，不进行渲染
    protected Script_05_21_UIPolygon()
    {
...
#if UNITY_EDITOR
[CustomEditor(typeof(Script_05_21_UIPolygon), true)]
public class Script_05_21_UIPolygonInspector : Editor
{
